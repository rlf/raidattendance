...
$lang = array_merge($lang, array(
	...
	//
		...
		'REALM_NAME'				=> 'Realm',
		'ARMORY_LINK'				=> 'Armory',
		'ARMORY_LINK_EXPLAIN'		=> 'Link to the relevant armory, e.g. http://eu.battle.net',
		...
		'FORUM_SIGNON'				=> 'Users allowed to signon',
		'FORUM_SIGNON_EXPLAIN'			=> 'Either users are expected to signoff if they do not show, or they are allowed to both signon and off',
		...
		'SUCCESS'					=> 'Success',
		'WARNING'					=> 'Warning',
		'ADDED_RAIDERS'				=> '%s was successfully added',
		'UPDATED_RAIDERS'			=> '%s was successfully saved',
		'NO_NEW_RAIDERS_IN_ARMORY'	=> 'There were no new raiders in the armory',
		'STATUS_NOT_IN_ARMORY'		=> '<b style="color:red">not in armory</b> ',
		'STATUS_UPDATED'			=> '<b style="color:green">updated</b> ',
		'STATUS_NEW'				=> '<b style="color:red">new</b> ',
		'STATUS_DEMOTED'			=> '<b style="color:red">demoted</b> ',
		'RAIDER_ALREADY_EXISTS'		=> 'A raider named %s already exists!',
		'ADD_RAIDER'				=> 'Add raider',
		'RAIDS'						=> 'Raids',
		'RAID_SETUP'				=> 'Raid Setup',
		'RAID_SETUP_EXPLAIN'		=> 'Enables configuration of multiple raids for different days.<br/>Leave the name blank to delete a raid-setup.<br/>Provide a name in the last slot to add a raid.',
